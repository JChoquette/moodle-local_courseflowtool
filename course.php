...
// // Check if the user has the cpapability to view this page.
...
// $testurl = new moodle_url('/local/courseflowtool/test.php', ['id' => $courseid]); 
// echo html_writer::tag('p', 'Click the button below to run the CourseFlow builder script:'); echo html_writer::tag('p', html_writer::link($testurl, 'Run Tool', ['class' => 'btn btn-primary']));
